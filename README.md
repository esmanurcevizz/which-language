...
* Improvements: Removed restrictions on loops and lists from V0.
* New Features: Implemented list (to view all contacts) and search (to filter by name) using loops.
* SPEC Contribution: Integrated the clear command as defined in the SPEC work to allow users to reset the entire database.
